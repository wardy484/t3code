...
export default function SidebarV2() {
  ...
  const orderedThreads = useMemo(
    ...
    [activeThreadRows, pinnedThreads, renderedSettledThreads, visibleSnoozedThreads],
  );
              ...
              <ul ref={attachListAutoAnimateRef} role="list" className="flex flex-col gap-px">
                {(() => {
                  const renderThreadRow = (
                    ...
                    const isCard =
                      section === "pinned" || (section === "active" && hierarchyRole !== "parent");
                  ...
                  for (const row of activeThreadRows) {
                    items.push(renderThreadRow(row.thread, "active", row.hierarchyRole));
                  }
