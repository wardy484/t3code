...
import { DelegatedWorkToolkitHandlersLive } from "./toolkits/delegatedWork/handlers.ts";
import { DelegatedWorkToolkit } from "./toolkits/delegatedWork/tools.ts";
...
export const DelegatedWorkToolkitRegistrationLive = McpServer.toolkit(DelegatedWorkToolkit).pipe(
  Layer.provide(DelegatedWorkToolkitHandlersLive),
);
...
export const layer = Layer.mergeAll(
  ...
  DelegatedWorkToolkitRegistrationLive,
