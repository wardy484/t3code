...
export const ExecutionEnvironmentCapabilities = Schema.Struct({
  ...
  /** Server understands the environmentFiles read/write RPCs. Absent on
      older servers, so newer clients show upgrade guidance instead of
      sending unsupported secret-management commands. */
  environmentFiles: Schema.optionalKey(Schema.Boolean),
